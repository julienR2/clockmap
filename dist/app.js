...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	var ClockMap = function ClockMap(props) {
	  this.state = {
	...
	ClockMap.prototype.getCoordinates = function () {
	  ...
	  return _requests2.default.coordinates(params);
	};
	...
	ClockMap.prototype.getLocationTime = function () {
	  ...
	  return _requests2.default.locationTime(params);
	};
	...
	ClockMap.prototype.getSnapshot = function () {
	  ...
	  }, _defineProperty(_params, 'style', 'feature:road.arterial|visibility:on'), _defineProperty(_params, 'format', 'png'), _defineProperty(_params, 'sensor', false), _params);

	  this.$clockMap.css('background', 'linear-gradient(to bottom, rgba(255,255,255,0.5) 0%,rgba(255,255,255,0.5) 100%), url(http://maps.googleapis.com/maps/api/staticmap?' + _jquery2.default.param(params) + ') no-repeat center center');
	};
	...
	ClockMap.prototype.templateSetUp = function () {
	  ...
	  if ((0, _jquery2.default)(container).length === 0) {
	    (0, _jquery2.default)('body').append('<div class="' + container.substring(1) + '"></div>');
	  }

	  (0, _jquery2.default)(container).addClass('clockmap');
	  (0, _jquery2.default)(container).html('<div class="clockmap-wrapper">' + '<div class="simple"></div>' + '<div class="hours-container">' + '<div class="hours"></div>' + '</div>' + '<div class="minutes-container">' + '<div class="minutes"></div>' + '</div>' + '<div class="seconds-container">' + '<div class="seconds"></div>' + '</div>' + '</div>' + '<div class="numeric"></div>');

	  this.$clockMap = (0, _jquery2.default)(container);
	  this.$hours = (0, _jquery2.default)(container + ' .hours');
	  this.$minutes = (0, _jquery2.default)(container + ' .minutes');
	  this.$seconds = (0, _jquery2.default)(container + ' .seconds');
